...
import com.im2ag.ecom.repository.ProductRepository;
...
/**
 * REST controller for managing {@link com.im2ag.ecom.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductResource {
    ...
    public List<Product> getAllProducts(
        ...
        if ("salespost-is-null".equals(filter)) {
            log.debug("REST request to get all Products where salespost is null");
            return StreamSupport
                .stream(productRepository.findAll().spliterator(), false)
                .filter(product -> product.getSalespost() == null)
