...
class OrderLineResourceIT {
    ...
    public static OrderLine createEntity(EntityManager em) {
        OrderLine orderLine = new OrderLine().quantity(DEFAULT_QUANTITY).unitPrice(DEFAULT_UNIT_PRICE).delivered(DEFAULT_DELIVERED);
        return orderLine;
    }
    ...
    public static OrderLine createUpdatedEntity(EntityManager em) {
        OrderLine orderLine = new OrderLine().quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).delivered(UPDATED_DELIVERED);
        return orderLine;
    }
    ...
    void createOrderLine() throws Exception {
        ...
        assertThat(testOrderLine.getDelivered()).isEqualTo(DEFAULT_DELIVERED);
    }
    ...
    void putExistingOrderLine() throws Exception {
        ...
        updatedOrderLine.quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).delivered(UPDATED_DELIVERED);
        ...
        assertThat(testOrderLine.getDelivered()).isEqualTo(UPDATED_DELIVERED);
    }
    ...
    void partialUpdateOrderLineWithPatch() throws Exception {
        ...
        partialUpdatedOrderLine.quantity(UPDATED_QUANTITY).delivered(UPDATED_DELIVERED);
    ...
    void fullUpdateOrderLineWithPatch() throws Exception {
        ...
        partialUpdatedOrderLine.quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).delivered(UPDATED_DELIVERED);
